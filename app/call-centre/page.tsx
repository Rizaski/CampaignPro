      ...
      <div className="flex">
        ...
        <aside className="hidden md:block lg:hidden md:w-64 md:fixed md:top-0 md:left-0 md:h-screen bg-primary text-primary-foreground overflow-y-auto z-30">
          ...
          <nav className="px-2 space-y-1 pb-4">
            ...
            <a href="/pledge-management" className="flex items-center gap-2 px-2 py-2 rounded-lg text-primary-foreground/70 hover:bg-primary-foreground/10 hover:text-primary-foreground font-medium text-[10px] transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Pledges
            </a>
            <a href="/call-centre" className="flex items-center gap-2 px-2 py-2 rounded-lg bg-primary-foreground/10 text-primary-foreground font-medium text-[10px]">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              Calls
        ...
        <main className="flex-1 md:ml-64 lg:ml-64 w-full min-h-screen pr-8 main-content-container">
          ...
          <div className="p-4 md:p-6 space-y-6 pb-20 md:pb-6 lg:pb-6">
            ...
            <div className="page-title">
              <h1 className="text-2xl font-bold text-gray-900">Call Centre</h1>
              <p className="text-gray-600 mt-1">Manage call centre operations and track call performance</p>
            </div>
            ...
            <div className="metrics-section">
              <div className="metrics-grid">
                <div className="metric-card">
                  <div className="metric-icon calls">
                ...
                <div className="metric-card">
                  ...
                  <div className="metric-content">
                    <div className="metric-value">1,892</div>
                ...
                <div className="metric-card">
                  ...
                  <div className="metric-content">
                    <div className="metric-value">66.4%</div>
            ...
            <div className="constituencies-card">
              <div className="constituencies-header">
                <h2 className="constituencies-title">Call Records</h2>
                <div className="header-actions">
                  ...
                  <button className="view-all-btn icon-only" title="Add New Call">
                    <svg className="button-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="table-container">
                <table className="voter-table">
                  <thead>
                    <tr>
                      <th className="visible-col">Call ID</th>
                      <th className="visible-col">Voter Name</th>
                      <th className="visible-col">Phone Number</th>
                      <th className="visible-col">Agent</th>
                      <th className="visible-col">Status</th>
                      <th className="visible-col">Duration</th>
                      <th className="actions-col">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="visible-col">C001</td>
                      <td className="visible-col">Ahmed Ali</td>
                      <td className="visible-col">+960 123-4567</td>
                      <td className="visible-col">Agent 1</td>
                      <td className="visible-col">
                        <span className="call-status-badge connected">Connected</span>
                      </td>
                      <td className="visible-col">5:32</td>
                      <td className="actions-col">
                        <div className="action-buttons">
                          ...
                          <button className="action-btn edit-btn" title="Edit Call">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg>
                          </button>
                          <button className="action-btn call-btn" title="Call Again">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                          </button>
                    ...
                    <tr>
                      <td className="visible-col">C002</td>
                      <td className="visible-col">Fatima Hassan</td>
                      <td className="visible-col">+960 987-6543</td>
                      <td className="visible-col">Agent 2</td>
                      <td className="visible-col">
                        <span className="call-status-badge missed">Missed</span>
                      </td>
                      <td className="visible-col">0:00</td>
                      <td className="actions-col">
                        <div className="action-buttons">
                          <button className="action-btn view-btn" title="View Details">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="table-footer">
                <div className="pagination-info">Showing 1-10 of 2,847 calls</div>
                <div className="pagination-controls">
                  ...
                  <span className="pagination-page">1 of 285</span>
