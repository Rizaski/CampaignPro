      ...
      <div className="flex">
        ...
        <aside className="hidden md:block lg:hidden md:w-64 md:fixed md:top-0 md:left-0 md:h-screen bg-primary text-primary-foreground overflow-y-auto z-30">
          ...
          <nav className="px-2 space-y-1 pb-4">
            ...
            <a href="/events" className="flex items-center gap-2 px-2 py-2 rounded-lg bg-primary-foreground/10 text-primary-foreground font-medium text-[10px]">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              Events
        ...
        <main className="flex-1 md:ml-64 lg:ml-64 w-full min-h-screen pr-8 main-content-container">
          ...
          <div className="p-4 md:p-6 space-y-6 pb-20 md:pb-6 lg:pb-6">
            ...
            <div className="page-title">
              <h1 className="text-2xl font-bold text-gray-900">Campaign Events</h1>
              <p className="text-gray-600 mt-1">Manage and track all campaign events and activities</p>
            </div>
            ...
            <div className="events-grid">
              <div className="event-card">
                <div className="event-header">
                  <span className="event-type-badge rally">Rally</span>
                  <div className="event-actions">
                    ...
                    <button className="action-btn delete-btn" title="Delete Event">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="event-content">
                  <h3 className="event-title">Presidential Campaign Rally</h3>
              ...
              <div className="event-card">
                <div className="event-header">
                  <span className="event-type-badge meeting">Meeting</span>
                  <div className="event-actions">
                    <button className="action-btn view-btn" title="View Details">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                ...
                <div className="event-content">
                  <h3 className="event-title">Strategy Planning Session</h3>
                  <div className="event-details">
                    <div className="event-detail">
                      <svg className="detail-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              ...
              <div className="event-card">
                <div className="event-header">
                  <span className="event-type-badge fundraiser">Fundraiser</span>
                  <div className="event-actions">
                    <button className="action-btn view-btn" title="View Details">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                ...
                <div className="event-content">
                  <h3 className="event-title">Charity Gala Dinner</h3>
                  <div className="event-details">
                    <div className="event-detail">
                      <svg className="detail-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
